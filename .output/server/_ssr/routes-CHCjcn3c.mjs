...
import { A as ListChecks, G as Database, J as Compass, R as GraduationCap, T as MessageSquare, et as ChartLine, h as ShieldCheck, it as BadgeCheck, lt as Activity, ot as ArrowRight, p as Sparkles, s as TrendingUp } from "../_libs/lucide-react.mjs";
import { a as CoordinateMarker, c as StaggerContainer, i as Card, l as StaggerItem, n as AppShell, o as EngineeringBg, r as Button, s as EngineeringDivider, t as AnimatedSection } from "./engineering-bg-BVrbPAIv.mjs";
import { i as useColleges, r as useBranches } from "./api-B18pGMTn.mjs";
import { n as StatCard, t as InlineStat } from "./stat-card-3R8-sfpK.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CHCjcn3c.js
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(StaggerContainer, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StaggerItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
								className: "mt-8 text-balance text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight",
								children: [
									"Precision ",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StaggerItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Data-driven college and branch recommendations using verified TNEA parameters. Navigate admissions with mechanical precision."
							}) }),
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, { className: "size-5" }), " Initialize System"]
										})
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: ["Execute ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-4" })]
								})
							]
						})
					}) }, f.title))
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AnimatedSection, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "technical-label mb-3",
						children: "Database Sample"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "text-3xl md:text-5xl font-extrabold tracking-tight",
						children: "Top-tier institutions"
						...
						children: ["Access Full Database ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-4" })]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						{
							...
							desc: "Cutoffs sourced directly from official TNEA seat allotment records with high fidelity."
						},
						{
							icon: Sparkles,
							title: "Neural Analysis",
							desc: "Recommendation engine trained on a decade of counselling patterns and shifting preferences."
						},
						{
							icon: MessageSquare,

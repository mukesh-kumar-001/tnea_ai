...
import { A as ListChecks, C as Moon, D as Menu, E as MessageCircle, J as Compass, N as Info, R as GraduationCap, T as MessageSquare, d as Sun, j as LayoutDashboard, p as Sparkles, s as TrendingUp, st as ArrowRight, t as X, tt as ChartLine, v as Search } from "../_libs/lucide-react.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/engineering-bg-ctUu3zKI.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: cn("sticky top-0 z-40 border-b transition-all duration-200 print:hidden", scrolled ? "border-border/60 glass shadow-xs" : "border-transparent bg-background/60 backdrop-blur-md"),
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
				className: "mt-20 border-t border-border/60 bg-surface-muted/30 blueprint-dots print:hidden",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FloatingChat, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CommandPalette, {})]
			})
		]
	});
}

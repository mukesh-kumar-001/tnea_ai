...
import { B as FingerprintPattern, O as MapPin, a as Trophy, k as LoaderCircle, m as Shield, rt as Building2, u as Target, ut as Activity } from "../_libs/lucide-react.mjs";
...
import { n as useAllColleges, r as useBranches, t as fetchRecommendations } from "./api-DrPEd7dX.mjs";
...
import { n as DISTRICTS, t as COMMUNITIES } from "./mock-data-uQeJaK5y.mjs";
import { t as Input } from "./input-DkqXAI82.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/counselling-a82C6O1t.js
...
function Counselling() {
	...
	const [inputMode, setInputMode] = (0, import_react.useState)("rank");
	const [showEasterEgg, setShowEasterEgg] = (0, import_react.useState)(false);
	const { mutate: generate, isPending: loading } = useMutation({
		mutationFn: async () => {
			if (inputMode === "rank") {
				if (!genRank || isNaN(parseInt(genRank)) || parseInt(genRank) <= 0) throw new Error("Please enter a valid General Rank.");
				if (community !== "any" && (!commRank || isNaN(parseInt(commRank)) || parseInt(commRank) <= 0)) throw new Error("Please enter a valid Community Rank.");
			} else if (!cutoff || isNaN(parseFloat(cutoff)) || parseFloat(cutoff) <= 0 || parseFloat(cutoff) > 200) throw new Error("Please enter a valid Cutoff between 1 and 200.");
			...
			if (inputMode === "cutoff") {
				finalGenRank = Math.max(1, Math.floor((200 - (parseFloat(cutoff) || 190)) * 300));
				finalCommRank = Math.max(1, Math.floor(finalGenRank * .6));
			}
		...
		onSuccess: (data) => {
			...
			const mapCategory = (list, cat) => {
				...
				list.forEach((item) => {
					...
					allRecos.push({
						code: item.college_code || (college ? college.code : String(item.college_id)),
						name: item.name,
						branch: item.branch,
		...
		onError: (err) => {
			console.error(err);
			toast.error(err.message || "System Error: Could not generate recommendations.");
		}
	});
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AnimatedSection, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							...
							children: "Smart Predictor"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 text-lg text-muted-foreground text-pretty",
							children: "Enter your details to get Dream, Target, and Safe college suggestions based on historical data."
						})
					]
				})
			})]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnimatedSection, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							className: "space-y-8 max-h-[65vh] overflow-y-auto pr-4 scrollbar-thin",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-2 text-sm font-bold border-b border-border/60 pb-2 mb-4 text-foreground/80",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FingerprintPattern, { className: "size-4" }), " Basic Details"]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center justify-between border-b border-border/60 pb-2 mb-4 mt-4 text-foreground/80",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center gap-2 text-sm font-bold",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FingerprintPattern, { className: "size-4" }), " Marks & Rank"]
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
													...
													onCheckedChange: (c) => setInputMode(c ? "cutoff" : "rank")
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
													htmlFor: "mode-toggle",
													className: "text-xs font-semibold cursor-pointer",
									...
									inputMode === "rank" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "grid grid-cols-1 sm:grid-cols-2 gap-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
											className: "technical-label block mb-2",
											children: "General Rank"
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
														...
														className: "h-8 w-24 text-right font-mono bg-primary/5 border-primary/20 focus-visible:ring-primary"
													})]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Slider, {
													...
													max: 200,
													step: .5,
													value: [parseFloat(cutoff) || 80],
													onValueChange: (v) => setCutoff(v[0].toString()),
													className: "mt-2"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "text-[10px] text-muted-foreground mt-3 text-right",
													children: "An estimated rank will be used for predictions."
												})
											]
										})
									})
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Target, { className: "size-4" }), " Preferences"]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "space-y-5",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
											className: "technical-label block mb-2",
											children: "Preferred Branches"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Building2, { className: "size-3.5" }), " Need Hostel?"]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
												id: "hostel-req",
												checked: hostel,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									onClick: () => {
										if (genRank === "8081" && community === "BC" && commRank === "4702" && gender === "Male" && parseFloat(cutoff) === 188.5) setShowEasterEgg(true);
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: loading ? "Finding Colleges..." : "Find Colleges"
										})
									]
								})
							]
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											children: "Enter your details and click 'Find Colleges' to see your suggestions."
										})
									]
								})
							}, "empty"),
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											children: "Searching for the best matches..."
										})
									]
								})
							}, "loading"),
							groups && !loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.div, {
								initial: {
									opacity: 0,
									y: 20
								},
								...
								children: groups.dream.length === 0 && groups.target.length === 0 && groups.safe.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
									className: "p-16 rounded-2xl text-center border-dashed border-border/80 flex flex-col items-center justify-center min-h-[300px]",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "font-extrabold text-2xl tracking-tight",
										children: "No colleges found matching your selection."
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-muted-foreground mt-3 max-w-md text-sm leading-relaxed",
										children: "No colleges matched your current parameters. Try adjusting your rank, community, or removing district/branch filters."
									})]
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Group, {
										icon: Trophy,
										title: "Dream Colleges",
										description: "Hard to get, but worth a try",
										list: groups.dream,
										tone: "warning",
										delay: 0
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Group, {
										...
										description: "Good chances of admission",
										list: groups.target,
										tone: "primary",
										delay: .2
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Group, {
										icon: Shield,
										title: "Safe Colleges",
										description: "Very high chances of admission",
										list: groups.safe,
										tone: "success",
										delay: .4
									})
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									r.type && r.type !== "Unknown" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										variant: "outline",
										className: "text-[10px]",
										children: r.type
									}),
									r.district && r.district !== "Unknown" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {

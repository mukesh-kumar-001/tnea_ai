...
//#region node_modules/.nitro/vite/services/ssr/assets/colleges.index-Tw0DSumb.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [(c.branches || []).slice(0, 4).map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								...
								children: b
							}, b)), c.branches && c.branches.length > 4 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Badge, {
								variant: "outline",

  ...
  return (
    <AppShell>
        ...
        <div className="container-page py-12 md:py-16 relative z-10">
          <AnimatedSection className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-2xl">
              <CoordinateMarker label="DATA.COMPARE" className="mb-4" />
              <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-balance">Comparative Analysis</h1>
              <p className="mt-4 text-lg text-muted-foreground text-pretty">Evaluate up to 4 institutions side-by-side using verifiable backend data arrays to make data-driven decisions.</p>
            </div>
      ...
      <div className="hidden print:block mb-8 mt-4 container-page">
        <h1 className="text-2xl font-bold border-b pb-2 mb-2">TNEA Comparative Analysis Report</h1>
        ...
        <AnimatedSection>
          <Card className="p-6 mb-8 rounded-2xl border-border/60 bg-card/80 backdrop-blur shadow-sm print:hidden">
            ...
            <p className="text-xs text-muted-foreground mt-3 font-mono">
              Matrix Capacity: {selectedIds.length} / 4 slots utilized
            </p>
          </Card>
        </AnimatedSection>
        ...
        {selectedColleges.length === 0 ? (
          <AnimatedSection>
            <Card className="p-16 rounded-2xl text-center border-dashed border-border/80 flex flex-col items-center justify-center min-h-[400px]">
              ...
              <div className="font-extrabold text-2xl tracking-tight">Empty Matrix</div>
              <p className="text-muted-foreground mt-3 max-w-sm text-sm leading-relaxed">
                Add at least two institutions to generate a side-by-side comparative analysis report.
              </p>
            </Card>
          </AnimatedSection>
        ) : (
